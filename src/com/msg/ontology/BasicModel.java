...
public class BasicModel
{
	...
	public BasicModel(OntologySimple os)
	{
		this.ontModel = os.getOntModel();
		this.uriBase = "http://qieyin/ontologies/child#";
	}
	...
	public List<OntClass> getSuperClasses(OntClass ontClass)
	{
		...
		Iterator<OntClass> subclasses = ontClass.listSuperClasses(true);
		while (subclasses.hasNext()) {
			OntClass superclass = subclasses.next();
	...
	{
		Iterator<?> iterNick = ontClass.listPropertyValues(prop);
